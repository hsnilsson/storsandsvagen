...
export default class IndelningPreview extends React.Component {
  render() {
    ...
    const entryValues = entry.getIn(["data", "indelning"]);
    const indelning = entryValues ? entryValues.toJS() : [];
    
    return <div>
      <Jumbotron image={image} title={entry.getIn(["data", "title"])} />
      <div className="bg-off-white pv4">
        <div className="mw7 center ph3 pt4">
          {indelning.map(({text, heading, imageUrl}, i) =>
