    ...
    return <div>
        ...
        <div className="bg-off-white pv4">
          <div className="ph3 mw7 center">
            ...
            <div className="tc">
              <a href="#" className="btn raise">Gå till årsmöten</a>
            </div>
          </div>
        </div>
          ...
          <div className="ph3 mw7 center">
            ...
            <div className="flex-l mhn2-l">
              <div className="w-40-l ph2-l">
                <h2 className="f2 b lh-title mb2">{entry.getIn(["data", "indelning", "heading"])}</h2>

                <p>{entry.getIn(["data", "indelning", "text"])}</p>
              </div>

              <div className="w-60-l ph2-l">
                <img src="{{.imageSrc}}" alt="" className="mb3"/>
              </div>
            </div>

            <div className="tc">
              <a href="{{.buttonLink}}" className="btn raise">Läs mer</a>
            </div>
